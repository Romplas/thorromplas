...
export const mockTickets: Ticket[] = [
  ...
  { id: 95, representante: 'Administrador', cliente: 'COMERCIO MEGA COLCHOES', motivo: 'Negociação', status: 'fechado', prioridade: 'Média', data_criacao: '02/03/2026 05:00', data_atualizacao: '02/03/2026 15:53', atualizado_por: 'Administrador' },
  ...
  { id: 85, representante: 'Representante', cliente: 'ATACADO DE ESPUMAS NORDESTE', motivo: 'Solicitação de Pedidos', status: 'fechado', prioridade: 'Baixa', data_criacao: '26/02/2026 13:47', data_atualizacao: '26/02/2026 13:47', atualizado_por: 'Representante' },
  { id: 84, representante: 'Representante', cliente: 'COMERCIO MEGA COLCHOES', motivo: 'Solicitação Interna Romplas', status: 'fechado', prioridade: 'Média', data_criacao: '26/02/2026 13:47', data_atualizacao: '26/02/2026 13:47', atualizado_por: 'Representante' },
];
