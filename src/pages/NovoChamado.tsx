...
import BookFormModal, { type BookFullFormData, defaultBookFullForm } from '@/components/chamado/BookFormModal';
...
export default function NovoChamado() {
  ...
  return (
    <Layout>
      ...
      {/* Book Form - mesmo componente usado no EditChamado (olho Book) */}
      <BookFormModal
        open={showBookForm}
        ...
        onConfirmCreate={(form, pdfFile) => {
          if (pdfFile) setAnexos(prev => [...prev, pdfFile]);
          setSpecialFormFilled(true);
          setShowBookForm(false);
          if (pdfFile) toast.success('Formulário Book salvo e PDF anexado!');
        }}
      />
    </Layout>
  );
